<template>
    ...
    <div>
      ...
      <!-- Header text section -->
      <div class="header-text-third-quest">
          <h3>AI image vs Human image</h3>
          <p>Which side do you support.</p>
      </div>
  
      <div class="box-third-quest" style="height: 350px; width: 350px">
        <img src="/img/third-quest.svg">
      </div>
  
      <NuxtLink to="/Quests"><button class="button-main-third-quest">AI</button></NuxtLink>
      <NuxtLink to="/Quests"><button class="button-main-third-quest">Human</button></NuxtLink>
  ...
  <style>
    ...
    .box-third-quest::before, .box-third-quest::after {
      content: "";
      position: absolute;
      top: 0;
      bottom: 0;
    ...
    .box-third-quest::before {
      left: 0;
      clip-path: polygon(0 10%, 100% 30%, 100% 70%, 0 90%);
    }
  
    .box-third-quest::after {
      right: 0;
