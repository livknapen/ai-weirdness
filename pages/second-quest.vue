<template>
    ...
    <div>
      ...
      <!-- Header text section -->
      <div class="header-text-second-quest">
          <h3>AI image vs Human image</h3>
          <p>Which side do you support.</p>
      </div>
  
      <div class="box-second-quest" style="height: 350px; width: 350px">
        <img src="/img/second-quest.svg">
      </div>
  
      <NuxtLink to="/Quests"><button class="button-main-second-quest">AI</button></NuxtLink>
      <NuxtLink to="/Quests"><button class="button-main-second-quest">Human</button></NuxtLink>
  
    
      <!-- Bottom background stars image -->
      <div class="stars-bg-bottom">
        <img class="stars-bg" src="/img/stars-bottom.svg" alt="Stars" />
      </div>
    </div>
  </template>
  ...
  <style>
    ...
    .box-second-quest::before, .box-second-quest::after {
      content: "";
      position: absolute;
      top: 0;
      bottom: 0;
    ...
    .box-second-quest::before {
      left: 0;
      clip-path: polygon(0 10%, 100% 30%, 100% 70%, 0 90%);
    }
  
    .box-second-quest::after {
      right: 0;
